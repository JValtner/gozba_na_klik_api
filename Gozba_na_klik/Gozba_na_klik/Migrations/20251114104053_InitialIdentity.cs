    ...
    public partial class InitialIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryPersonSchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeliveryPersonSchedules_AspNetUsers_DeliveryPersonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAlergens_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasAllergenWarning = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPrice = table.Column<decimal>(type: "numeric", nullable: false),
                    SelectedAddons = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ActiveOrderId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryPersonSchedules_DeliveryPersonId",
                table: "DeliveryPersonSchedules",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Orders_ActiveOrderId",
                table: "AspNetUsers",
                column: "ActiveOrderId",
                principalTable: "Orders",
                principalColumn: "Id",
