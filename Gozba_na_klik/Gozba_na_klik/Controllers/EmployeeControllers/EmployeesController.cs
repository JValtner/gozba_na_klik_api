...
namespace Gozba_na_klik.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<EmployeeListItemDto>>> GetEmployeesByRestaurant(int restaurantId)
        {
        ...
        public async Task<IActionResult> SuspendEmployee(int employeeId)
        {
            var ownerId = User.GetUserId();
